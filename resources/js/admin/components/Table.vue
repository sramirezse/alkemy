...
export default {
    ...
    methods: {
        ...
        refresh(page) {
            ...
            this.page = page;
            this.fetchData("", this.perPage, offset);
        ...
        deleteItems(check) {
            ...
            this.$swal({
                ...
                text: `Se eliminará(n) ${this.checkedData.length >=1 ? this.checkedData.length + ' archivos' : '1 archivo'}`,
                showDenyButton: true,
                icon:'question',
                // showCancelButton: true,
                cancelButtonText:
                    '<i class="fe fe-x-circle me-2"></i> Cancelar',
